...
import { BaseStyleProps, DisplayObjectConfig, Shape } from '../displayObjects/types';
import { Node } from './Node';
import { IAnimationTimeline } from '../types/Animation';
import { ERROR_MSG_METHOD_NOT_IMPLEMENTED, ERROR_MSG_USE_DOCUMENT_ELEMENT } from '../constants/error';
import { Group, DisplayObject } from '../css';
import { BUILT_IN_PROPERTIES } from '../css/CSS';
