...
import { Tuple4Number } from '../../types';
...
export function isCSSGradientValue(object: any): object is CSSGradientValue {
  return !!(object as CSSGradientValue).type && !!(object as CSSGradientValue).value;
}
...
export function isCSSRGB(object: any): object is CSSRGB {
  return object && !isNil((object as CSSRGB).r) && !isNil((object as CSSRGB).g) && !isNil((object as CSSRGB).b);
}
